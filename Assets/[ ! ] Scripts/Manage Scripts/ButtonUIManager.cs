...
public class ButtonUIManager : MonoBehaviour
{
    ...
    private string Add25Gems_ID = "com.OutbreakCompany.FullForce.25gemspack";
    private string Add75Gems_ID = "com.OutbreakCompany.FullForce.75gemspack";
    private string Add150Gems_ID = "com.OutbreakCompany.FullForce.150gemspack";
    private string Add250Gems_ID = "com.OutbreakCompany.FullForce.250gemspack";
    private string Add700Gems_ID = "com.OutbreakCompany.FullForce.700gemspack";

    [Header("Subscriptions")]
    private string SubX2CoinsDaily_ID = "com.OutbreakCompany.FullForce.subx2coinsdaily";
    private string SubX2CoinsWeekly_ID = "com.OutbreakCompany.FullForce.subx2coinsweekly";
    private string SubX2CoinsMonthly_ID = "com.OutbreakCompany.FullForce.subx2coinsmonthly";
    ...
    private void Start()
    {
        ...
        {
            RecordData.text = $"[*] Point Gather Record: {GameDataManager.HighestCoinNumbRecord()}\r\n\r\n[*] Point Gathered this match: {GameDataManager.MatchCoinNumbGathered()}";
        }

        if (RecordData != null && GameDataManager.IsMonthlySubscriptionActive() == true)
        {
            RecordData.text = $"[*] Point Gather Record: {GameDataManager.HighestCoinNumbRecord()}\r\n\r\n[*] Point Gathered this match: {GameDataManager.MatchCoinNumbGathered()}\r\n\r\n( + {GameDataManager.MatchCoinNumbGathered()} Point - x2 Pack Bonus )";
    ...
    {
        _audioSource.PlayOneShot(ButtonClickSound);
        SceneManager.LoadScene("AddGems");
    }

    public void AddCoins()
    {
        _audioSource.PlayOneShot(ButtonClickSound);
        SceneManager.LoadScene("AddCoins");
    }
