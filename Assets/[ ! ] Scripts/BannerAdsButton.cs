...
public class BannerAdsButton : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            var product = CodelessIAPStoreListener.Instance.StoreController.products.WithID("com.OutbreakCompany.FullForce.removeads");
    ...
    {
        if (product.definition.id == "com.OutbreakCompany.FullForce.removeads")
        {
