...
public static class GameDataManager
{
    ...
    {
        BinarySerializer.Save(playerData, "FullForce-data-1.txt");
    ...
    static void LoadPlayerData()
    {
        try
        {  
            if (BinarySerializer.HasSaved("FullForce-data-1.txt"))
            {
                playerData = BinarySerializer.Load<PlayerData>("FullForce-data-1.txt");
